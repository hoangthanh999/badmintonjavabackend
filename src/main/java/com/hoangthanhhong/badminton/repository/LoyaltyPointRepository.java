...
public interface LoyaltyPointRepository extends JpaRepository<LoyaltyPoint, Long> {
        ...
        @Query("""
                            ...
                            ORDER BY lp.expiresAt ASC
                        """)
        List<LoyaltyPoint> findExpiringPoints(@Param("expiryDate") LocalDateTime expiryDate);
        ...
        @Query("""
                            ...
                            ORDER BY lp.createdAt DESC
                        """)
        Page<LoyaltyPoint> findByUserIdOrderByCreatedAtDesc(
                        @Param("userId") Long userId,
                        Pageable pageable);
        ...
        @Query("""
                            ...
                            ORDER BY lp.expiresAt ASC
                        """)
        List<LoyaltyPoint> findExpiringPointsForUser(
                        @Param("userId") Long userId,
                        @Param("expiryDate") LocalDateTime expiryDate);
